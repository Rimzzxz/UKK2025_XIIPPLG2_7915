...
<head>
    ...
    <title>Register Web To do List</title>
    <!-- Bootstrap CSS -->
...
<body>
    <div class="login-container text-center">
        ...
        <h3 class="mb-4 text-primary">Registrasi Web To do List</h3>
        <form method="post">
            ...
            <div class="mb-3">
                <input class="form-control" id="inputEmail" type="text" name="name" placeholder="Masukkan Nama" />
            </div>
            <div class="mb-3">
                <input class="form-control" id="inputEmail" type="text" name="email" placeholder="Masukkan Email" />
            </div>
            <button type="submit" class="btn btn-custom w-100 mb-3">Registrasi</button>
        </form>
        <p class="mt-3 mb-0 text-dark">sudah punya Akun? <a href="login.php" class="text-decoration-none">Login</p>
    </div>
